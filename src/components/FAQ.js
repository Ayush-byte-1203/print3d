    ...
    return (
        <section className={`faq-premium ${standalone ? 'standalone' : ''}`} id="faq">
            <div className="container" ref={revealRef}>
                ...
                {/* ── Human Support CTA ── */}
                <div className="faq-footer-cta reveal-hidden reveal-stagger-2">
                    <div className="cta-support-card glass-panel">
                        <div className="support-icon-circle">
                            <MessageCircle size={28} />
                        </div>
                        <div className="support-cta-text">
                            <h3>Still need assistance?</h3>
                            <p>Speak directly with our engineering team on WhatsApp for technical queries.</p>
                        </div>
                        <a href="https://wa.me/917043591952" target="_blank" rel="noreferrer" className="btn-support-whatsapp">
                            Chat with us
                        </a>
                    </div>
                </div>
